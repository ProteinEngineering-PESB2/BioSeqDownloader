...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--fields', help='Fields to include in the output', default="accession,protein_name,sequence,ec,lineage,organism_name,xref_pfam,xref_kegg,xref_alphafolddb,xref_refseq,xref_brenda,xref_reactome,xref_pdb,xref_interpro,xref_string,go_id")
